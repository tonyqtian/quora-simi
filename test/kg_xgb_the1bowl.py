...
train = pd.read_csv('D:\BaiduCloud\PostGraduate\DL\Quora\\train.csv')
test = pd.read_csv('D:\BaiduCloud\PostGraduate\DL\Quora\\test.csv')
...
# train.to_csv('../output/train_features_1bowl.csv', index=False)
test = get_features(test)
test.to_csv('../output/test_features_1bowl.csv', index=False)
# raise RuntimeError
print('Finished.')
