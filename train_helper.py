...
parser.add_argument("--train-bowl-feature-path", dest="train_bowl_feature_path", type=str, metavar='<str>', default='', help="The path to the train bowl feature set")
parser.add_argument("--test-bowl-feature-path", dest="test_bowl_feature_path", type=str, metavar='<str>', default='', help="The path to the test bowl feature set")
parser.add_argument("--bowl-feature-list", dest="bowl_feat_list", type=str, metavar='<str>', default='', help="bowl feature column list")
...
parser.add_argument("--embedding-dim", dest="embd_dim", type=int, metavar='<int>', default=300, help="Embeddings dimension (default=300)")
parser.add_argument("--fasttext-dim", dest="ft_dim", type=int, metavar='<int>', default=0, help="FastText embeddings dimension (default=0)")
parser.add_argument("--fasttext-source", dest="ft_src", type=int, metavar='<str>', default='', help="Training material for FastText embeddings")
...
parser.add_argument("--train-batch-size", dest="train_batch_size", type=int, metavar='<int>', default=16, help="Train Batch size (default=8)")
parser.add_argument("--eval-batch-size", dest="eval_batch_size", type=int, metavar='<int>', default=128, help="Eval Batch size (default=8)")
parser.add_argument("--rnn-dropout", dest="rnn_dropout", type=float, metavar='<float>', default=0.4, help="The RNN dropout probability. To disable, set to zero (default=0.4)")
parser.add_argument("--dense-dropout", dest="dense_dropout", type=float, metavar='<float>', default=0.3, help="The dense layer dropout probability. To disable, set to zero (default=0.3)")
parser.add_argument("--input-dropout", dest="input_dropout", type=float, metavar='<float>', default=0.0, help="The embedding input dropout probability. To disable, set to zero (default=0.0)")
parser.add_argument("--re-weight", dest="re_weight", action='store_true', help="Show log on stdout")
